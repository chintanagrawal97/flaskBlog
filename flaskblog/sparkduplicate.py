...
JSON_KEY = []
    ...
    def __init__(selselff,CLUSTER_ID,APPLICATION_ID,KEY_WORD,EXCLUSIVE,LOGPATH):
    ...
    def info_check(self,IselfNFO_STR):
        keywords = ["Caused by:"]
        for k in keywords:
            if k in INFO_STR:
                return True
    ...
    def sp_error_cheselfck(self,JsonRes):
    ...
    def sp_warn_checselfk(self,JsonRes):
    ...
    def container_keselfyword_research(self,p):
        global JSON_ARRAY
        global JSON_KEY
    ...
    def getListOfFilselfes(self,dirName):
    ...
    def MainProgram(self):
        ...
        data =list()
        data=self.getListOfFiles(slef.LOGPATH+'/'+CLUSTER_ID+'/containers/'+APPLICATION_ID)
...
if __name__ == '__main__':
    response = MainProgram('j-100','app2','',False,'/Users/achintan/Desktop/emr')
    for key in response : 
        print(key)